...
if submit and prompt.strip():
    ...
    # =========================================================
    # 📊 REGION VISUAL (INLINE - replaces table)
    # =========================================================
    df_region = parse_regions(reply)

    if df_region is not None:

        st.markdown("### 📍 Regional Priority Insights")
    ...
    # 🧬 BRAND VISUAL (INLINE)
    # =========================================================
    st.markdown("### 🧬 Brand Performance Insights")
